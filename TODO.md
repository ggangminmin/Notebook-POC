...
- **마지막 업데이트**: 2026-01-16 (웹 검색 UI 간소화)
...
- [x] **웹 검색 UI 간소화 (2026-01-16 신규)**:
  - Deep Research 배너 제거 (심층 분석 기능 제거)
  - 빠른 검색/심층 분석 토글 버튼 제거
  - 검색 타입 자동 고정: Fast Research만 사용
  - 웹 URL 탭 제거 (파일 업로드 탭만 유지)
  - 중복 "지원 형식" 워딩 제거
...
### 웹 검색 (선택적)
- [x] Fast Research (빠른 검색)
- [x] Tavily API 통합 (월 1,000 크레딧 무료, 검색 1회당 2 크레딧)
- [x] GPT-4o 요약 시스템 (웹페이지 3줄 요약)
- [x] 검색어 최적화 (GPT-4o-mini)
- [x] 소스 타입별 아이콘 (📄 파일, 🌐 웹)
- [x] 크레딧 소진 시 경고 표시
