...
### 8. 웹 검색 기능 (선택적)
- **빠른 웹 검색**: 검색어 입력만으로 최신 웹 정보 자동 수집·요약
- **Tavily API 통합**: AI용 전문 검색 엔진 (월 1,000 크레딧 무료, 검색 1회당 2 크레딧)
- **GPT-4o 요약**: 각 웹페이지를 질문에 맞게 3줄로 압축 요약
- **검색어 최적화**: GPT-4o-mini로 검색어를 최신 정보용으로 자동 변환
- **파일처럼 활용**: 검색 결과를 소스로 추가하여 AI 대화에 참고
- **크레딧 소진 경고**: API 한도 초과 시 자동 알림
